...
export const Full_Content_Routes: Routes = [
    ...
    {
        path: 'mg',
        loadChildren: () => import('../../components/backend/manage/manage.module').then(m => m.ManageModule)
    },
    {
        path: 'rp',
        loadChildren: () => import('../../components/backend/report/report.module').then(m => m.ReportModule)
    },
