...
export class NavService implements OnDestroy {
  ...
  MENUITEMS: Menu[] = [
    ...
    { headTitle: 'Manage' },
    {
      title: 'Product', icon: 'ti-menu', type: 'sub', active: false,
      children: [
        { path: '/mg/products', title: 'Products', type: 'link' },
        { path: '/mg/categories', title: 'Categories', type: 'link' },
        { path: '/mg/brands', title: 'Brands', type: 'link' },
        { path: '/mg/tags', title: 'Tags', type: 'link' },
       ]
    },
    {
      title: 'Stock', icon: 'ti-split-h', type: 'sub', active: false,
      children: [
        { path: '/mg/stock-take', title: 'Stock take', type: 'link' },
        { path: '/mg/suppliers', title: 'Suppliers', type: 'link' },
       ]
    },
    {
    ...
    { headTitle: 'Till' },
    {
      title: 'Till', icon: 'ti-menu', type: 'sub', active: false,
      children: [
        { path: '/ts/product-list', title: 'Till', type: 'link' },
       ]
    },
    {
      title: 'Supplier', icon: 'ti-truck', type: 'sub', active: false,
      children: [
        { path: '/mg/suppliers', title: 'Suppliers', type: 'link' },
       ]
    },
    ...
    { headTitle: 'Report' },
    {
      title: 'Sales', icon: 'ti-agenda', type: 'sub', active: false,
      children: [
        { path: '/rp/sales-by-time-interval', title: 'Time interval', type: 'link' },
        { path: '/rp/sales-by-product', title: 'Product', type: 'link' },
      ]
    },
    {
